    ...
    <div class="ml-[420px] w-full">
        <div class="w-full">
            ...
            <div class="border-l border-green-500 w-full">
                <div class="bg-[#F0F0F0] fixed z-10 min-w-[calc(100vw-420px)] flex justify-between items-center p-2">
                    <div class="flex items-center">
                        <img src="https://random.imagecdn.app/100/100" class="rounded-full mx-1 w-10" alt="" />
                ...
                <div class="px-20 text-sm">
                    <div class="flex w-[calc(100%-50px)]">
                        <div class="inline-block bg-white p-2 rounded-md my-1">
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Expedita, eius. Voluptatem magnam
                            perspiciatis, pariatur sed cum reiciendis corrupti error nostrum est consectetur obcaecati
                            nesciunt minima praesentium. Laboriosam tenetur similique assumenda!
                        </div>
                    </div>
            ...
            <div class="w-[calc(100vw-420px)] p-2.5 z-10 bg-[#F0F0F0] fixed bottom-0">
                <div class="flex items-center justify-center">
                    ...
                    <button type="button" class="ml-3 p-2 w-12 flex items-center justify-center">
